...
const Portfolio = () => {
  ...
  return (
    <section className="pb-6 px-6">
      <section className="bg-[#B3C4BE] dark:bg-black text-[#38302E] dark:text-[#ccdad1] px-6 sm:px-6 md:px-10 lg:px-20 py-6 sm:py-10 md:py-8 lg:py-12 rounded-md text-center my-8 dark:sm:my-4 dark:md:my-6 shadow-md w-full sm:w-[90%] md:w-[90%] mx-auto motion-safe:transition-colors motion-safe:duration-300">
            ...
            >
              ...
              <div className="flex flex-col items-center">
                <a
                  ...
                  className="w-full sm:w-[250px] px-4 py-2 mb-2 text-[#ccdad1] dark:text-black bg-black dark:bg-gray-400 rounded text-sm sm:text-base font-medium hover:outline hover:outline-2 hover:outline-[#646cff] hover:dark:outline-orange-400 hover:rounded-[30px] motion-safe:transition-all motion-safe:duration-300"
                >
                  Live Demo
                </a>
                <a
